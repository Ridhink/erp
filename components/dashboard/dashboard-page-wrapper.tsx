...
export function DashboardPageWrapper() {
  ...
  // Default to lead dashboard
  return <LeadDashboardView />
}

// Lead Dashboard (from Figma design)
...
function AdminDashboardView() {
  const data = {
    userName: 'Admin',
    metrics: [
      { title: 'Total Leads', value: 1284, change: 12.5, format: 'number' as const },
      { title: 'Conversion Rate', value: 24.2, change: 3.1, format: 'percentage' as const },
      { title: 'Revenue', value: 42500, change: 18.2, format: 'currency' as const },
      { title: 'Active Teams', value: 12, change: 18.2, format: 'number' as const },
    ],
    revenueData: [
      { day: 'Mon', value: 4500 },
      { day: 'Tue', value: 6200 },
...
function SalesDashboardView() {
  const data = {
    ...
    metrics: { myLeads: 15, callsToday: 8, conversions: 2, revenue: 12400 },
    recentLeads: [
